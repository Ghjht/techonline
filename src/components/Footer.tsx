    ...
    <footer className="bg-gray-900 text-gray-300 mt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-sm leading-relaxed mb-4">
              Votre partenaire de confiance pour le matériel informatique haut de gamme au Maroc.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="mailto:helpstechit@gmail.com" className="hover:text-white transition-colors">Contact</a></li>
              <li><a href="tel:+212728697150" className="hover:text-white transition-colors">+212 7 28 69 71 50</a></li>
              <li><span className="text-gray-500">Lun-Sam 9h-19h</span></li>
            </ul>
          </div>
            ...
            <div className="flex items-center gap-3 text-sm text-gray-500">
              ...
              <div className="flex gap-2">
                {paymentMethods.map((p) => (
                  <span key={p.name} className="flex items-center gap-1 bg-gray-800 px-2.5 py-1 rounded text-xs" title={p.name}>
                    {p.icon} {p.name}
                  </span>
                ))}
              </div>
        ...
        <div className="border-t border-gray-700 mt-6 pt-6 text-center text-sm text-gray-500">
          ...
          <p className="mt-1">Rue Al Karam N°280 CYM Rabat, Maroc</p>
        </div>
      </div>
    </footer>
  );
